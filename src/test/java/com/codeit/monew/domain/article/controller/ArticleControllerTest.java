...
class ArticleControllerTest {
  ...
  void searchArticles_success() throws Exception {
    ...
    // CursorPageResponseDate -> CursorPageResponse로 통일 및 nextAfter를 String으로 변경
    CursorPageResponse<ArticleDto> response = new CursorPageResponse<>(
        List.of(articleDto),
        "next-cursor-value",
        "2026-05-27T10:00:00.000000",
        1,
        1L,
        false
    );
    ...
    mockMvc.perform(get("/api/articles")
        ...
        .andExpect(jsonPath("$.nextAfter").value("2026-05-27T10:00:00.000000"))
